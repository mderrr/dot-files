...
PATH_BAR_ICONS_FORMAT = "~/.config/qtile/icons/bar-alt/{}.svg"
...
def getArrowSpacer(color, previous_color, arrow_type = "left"):
    return widget.TextBox( text       = CHAR_ARROW if arrow_type == "left" else CHAR_ARROW_RIGHT
...
def getBar(widget_instances_list):
    ...
    for widget in widget_instances_list:
        ...
        if widget.use_arrow is not None: 
            ...
            a = widget.foreground if widget.use_arrow == "left" else previous_color_f
            bar_widgets_array.append( getArrowSpacer(a, previous_color, widget.use_arrow) )
        ...
        previous_color_f = widget.foreground
